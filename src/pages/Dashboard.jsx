...
const cleanString = (str) => {
  ...
  // 🌟 คำนวณกราฟที่ 1: ดึงทุกสาขาตามปีที่เลือกที่กราฟ โดยไม่สนใจฟิลเตอร์ด้านบน
  ...
  }, [surveyGroup, graphSurveyYear]);

  // 🌟 คำนวณกราฟที่ 2: ดึงทุกสาขาตามปีที่เลือกที่กราฟ โดยไม่สนใจฟิลเตอร์ด้านบน
